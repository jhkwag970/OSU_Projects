...
public abstract class ListTest {
    ...
    @Test
    public final void testAddRightFrontLeftEmptyRightEmpty2() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(0);
        List<String> list2 = this.createFromArgsRef(0, "blue", "red");
        /*
         * Call method under test
         */
        list1.addRightFront("red");
        list1.addRightFront("blue");
        /*
         * Assert that values of variables match expectations
         */
        assertEquals(list2, list1);
    ...
    @Test
    public final void testAddRightFrontLeftEmptyRightNonEmpty2() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(0, "red", "blue");
        List<String> list2 = this.createFromArgsRef(0, "yellow", "green", "red",
                "blue");
        /*
         * Call method under test
         */
        list1.addRightFront("green");
        list1.addRightFront("yellow");
        /*
         * Assert that values of variables match expectations
         */
        assertEquals(list2, list1);
    ...
    @Test
    public final void testAddRightFrontLeftNonEmptyRightEmpty2() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "yellow", "orange",
    ...
    @Test
    public final void testAddRightFrontLeftNonEmptyRightNonEmpty2() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "yellow", "orange",
    ...
    @Test
    public final void testRemoveRightFrontLeftEmptyRightNonEmpty2() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(0, "green", "red", "blue");
         ...
         */
        String s = list1.removeRightFront();
        String s2 = list1.removeRightFront();
        /*
         * Assert that values of variables match expectations
         */
        assertEquals("green", s);
    ...
    @Test
    public final void testRemoveRightFrontLeftNonEmptyRightNonEmpty2() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "yellow", "orange",
    ...
    @Test
    public final void testRetreatRightLengthZero() {
    ...
    @Test
    public final void testRetreatRightLengthZero2() {

        List<String> list1 = this.createFromArgsTest(5, "red", "blue", "yellow",
                "green", "purple");
        List<String> list2 = this.createFromArgsRef(4, "red", "blue", "yellow",
                "green", "purple");
    ...
    @Test
    public final void testRetreatRightLengthNonZero() {
    ...
    @Test
    public final void testRetreatRightLengthNonZero2() {

        List<String> list1 = this.createFromArgsTest(3, "red", "blue", "yellow",
                "green", "purple", "gray");
        List<String> list2 = this.createFromArgsRef(2, "red", "blue", "yellow",
                "green", "purple", "gray");
    ...
    @Test
    public final void testRetreatLeftLengthOne() {
    ...
    @Test
    public final void testRetreatLeftLengthOne2() {
    ...
    @Test
    public final void testRetreatLeftLengthtwo() {
