...
class StringLT2 implements Comparator<String> {
    @Override
...
public final class wordCounter2 {
    ...
    public static void outputHeader(String text, SimpleWriter out) {
        ...
        Set<String> wordIndex = new Set1L<String>();
        ...
        for (String str : wordIndex) {
            out.println("<tr>");
            out.print("<td>" + str + "</td>");
            out.print("<td>" + word.value(str) + "</td>");
            out.println("</tr>");
        }
    ...
    public static void processFeed(SimpleReader fileIn,
            Map<String, Integer> word, Set<String> wordIndex) {
     ...
     * </pre>
     */
    private static String removeMin(Set<String> wordIndex) {
        assert wordIndex != null : "Violation of: q is not null";

        Set<String> tmp = new Set1L<String>();
        Comparator<String> order = new StringLT();
        String min = wordIndex.removeAny();
     ...
     *          order.compare]
     */
    public static void sort(Set<String> wordIndex) {
        Set<String> tmp = new Set1L<String>();

        int cnt = 0;
        while (wordIndex.size() != 0) {
            tmp.add(removeMin(wordIndex));
            cnt++;
        }
