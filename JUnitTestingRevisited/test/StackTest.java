...
public abstract class StackTest {
    ...
    public final void testPushNonEmpty2() {
        ...
        Stack<String> s = this.createFromArgsTest("red", "blue");
        Stack<String> sExpected = this.createFromArgsRef("yellow", "green",
                "red", "blue");
    ...
    public final void testPopNonEmpty() {
        Stack<String> s = this.createFromArgsRef("red", "blue", "orange");
        Stack<String> sExpected = this.createFromArgsRef("orange");
