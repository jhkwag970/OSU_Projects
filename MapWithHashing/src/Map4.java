...
//        int index = mod(key.hashCode(), length);
//
//        Map<K, V> tmp = new Map1L<K, V>();
//        tmp.add(key, value);
//        this.hashTable.setEntry(index, tmp);
...
//        int index = mod(key.hashCode(), length);
//
//        Pair<K, V> result = this.hashTable.entry(index).remove(key);
//
//        if (this.hashTable.entry(index).size() == 0) {
//            this.hashTable.makeUnexaminable(index);
//        }
...
//        int index = mod(key.hashCode(), length);
//
//        V value = this.hashTable.entry(index).value(key);
...
//        int length = this.hashTable.length();
//        int index = mod(key.hashCode(), length);
//        boolean result = this.hashTable.entry(index).hasKey(key);
