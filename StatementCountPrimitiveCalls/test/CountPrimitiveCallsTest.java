...
public final class CountPrimitiveCallsTest {
    ...
    public void test4true() {
        Statement s1 = this.createFromArgs("data/test5.bl", true);
        Statement s2 = this.createFromArgs("data/test5.bl", true);
        int count = CountPrimitiveCalls.countOfPrimitiveCalls(s1);
        assertEquals(5, count);
        assertEquals(s2, s1);
    }
    ...
    public void test5true() {
        Statement s1 = this.createFromArgs("data/test6.bl", true);
        Statement s2 = this.createFromArgs("data/test6.bl", true);
        int count = CountPrimitiveCalls.countOfPrimitiveCalls(s1);
        assertEquals(3, count);
        assertEquals(s2, s1);
    }
